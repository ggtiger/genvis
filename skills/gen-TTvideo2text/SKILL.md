---
name: gen-TTvideo2text
displayName: Genvis抖音短视频转文字Skills
...
**ASR Configuration:**
- Environment variables auto-injected by Genvis platform
...
| ASR not configured | Environment variables missing | Run via Genvis platform (auto-injects vars) |
...
2. **ASR Platform:** This skill requires Genvis platform's ASR service integration
