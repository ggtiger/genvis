  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden">
      ...
      <div className="absolute inset-y-0 right-0 max-w-3xl w-full bg-white/95 dark:bg-slate-900/98 shadow-2xl flex flex-col">
        ...
        <div className="px-6 py-5 bg-white/50 dark:bg-white/[0.04] border-b border-gray-200 dark:border-white/10">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              {icon && (
                <div className="p-2 bg-white/80 dark:bg-white/10 rounded-lg shadow-sm text-gray-600 dark:text-slate-300">
                  {icon}
                </div>
              )}
              <div>
            ...
            <button
              onClick={onClose}
              className="p-2 hover:bg-gray-200 dark:hover:bg-white/10 rounded-lg text-gray-400 dark:text-slate-500 hover:text-gray-600 dark:hover:text-white transition-all"
            >
        ...
        {/* Content */}
        <div className="flex-1 overflow-hidden bg-gray-50/80 dark:bg-slate-900/50">
          {children}
        </div>
      </div>
    </div>
